...
fit_gamlss_for_feature <- function(data, feature_name, model_dir,
  ...
  tryCatch({
    ...
    # deparse1 collapses multi-line formula deparsing to a single string
...
run_gamlss_harmonisation <- function(data, features, output_dir, formula_terms,
  ...
  # output_dir is the final models directory -- no further "models" appended here
  ...
  if (n_cores > 1) {
    ...
    parallel::clusterExport(cl,
      c("data", "formula_terms", "batch_var", "id_var", "longitudinal",
        "log_transform", "family_order", "output_dir", "fit_gamlss_for_feature",
