...
#   --output        Output directory for harmonised CSVs
...
models_dir       <- resolve_arg(opt$models,    file.path(cfg$output$base %||% "output", "models"))
output_dir       <- resolve_arg(opt$output,    cfg$output$harmonised, "output/harmonised")
